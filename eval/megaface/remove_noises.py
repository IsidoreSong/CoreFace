...
def main(args):
    ...
    print('fs_moise_map', len(fs_noise_map))
...
def parse_arguments(argv):
    ...
    parser.add_argument('--facescrub-noises',
                        type=str,
                        help='',
                        default='/dataset/megaface/data/facescrub_noises.txt')
    parser.add_argument('--megaface-noises',
                        type=str,
                        help='',
                        default='/dataset/megaface/data/megaface_noises.txt')
    ...
    parser.add_argument('--feature-dir-input',
                        type=str,
                        help='',
                        default='/dataset/megaface/feature_out')
    parser.add_argument('--feature-dir-out',
                        type=str,
                        help='',
                        default='/dataset/megaface/feature_out_clean')
